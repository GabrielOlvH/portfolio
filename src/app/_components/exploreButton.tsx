...
export default async function ExploreButton(){
    ...
    return (
        <button className={styles.exploreButton}>
            ...
            <div className={styles.flex}>
                <svg className={styles.moon} viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"
                ...
                <span className={styles.exploreTitle}>Launch</span>
            </div>
            <svg className={styles.rocket} version="1.1" xmlns="http://www.w3.org/2000/svg"
